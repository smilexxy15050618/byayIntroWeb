      ...
      <>
        ...
        <DescWrapper
          ...
          {TECHNOLOGY_STACK.map((item, index) => (
            <TechnologyCol lg={8} md={12} key={index}>
              <TechnologyCard>
                <div className="wrap">
                  <div className="cover">
                  ...
                  <div className="title">
                    {item.title.map((it: string, titleIndex: number) => (
                      <p key={titleIndex}>{it}</p>
                    ))}
                  </div>
                  <div className="desc">
                    {item.desc.map((desc: string, descIndex: number) => (
            ...
            <TechnologyCol lg={8} key={index} style={{ marginBottom: 60 }}>
              <SecurityCard>
                <div className="wrap">
                  ...
                  {item.list.map((it: string, headIndex: number) => (
                    <p key={headIndex}>{it}</p>
                  ))}
                </div>
              </SecurityCard>
            </TechnologyCol>
