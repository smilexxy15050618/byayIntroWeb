...
import { Col, ColProps, Container, Row, Visible } from 'react-grid-system';
...
const BACKGOURND_XS = 'https://cdn.byai.com/static/official-website/home/fuwu.png';

const SERVICE_SUPPORT = [
  {
    title: '丰富的资源配置',
    descList: ['线路市场，对接丰富优质线路', '话术市场，对接海量金牌话术', '解决方案，26行业成熟应用方案'],
  ...
  {
    title: '每周产品更新日志',
    descList: ['每周迭代，见证产品卓越进阶', '图文并茂，让每一次升级清晰顺滑', '及时推送，最新应用总是先知先觉'],
...
const ServeContainer = styled(Container)`
  ...
  height: 630px;
  background-image: url('//cdn.byai.com/static/official-website/animation/assistant-1222.svg');
      ...
      {(visible, setVisible) => (
        <>
          <Wrapper>
            <Banner
              title="始终坚守客户第一"
              desc="百应坚守始终以客户为中心，在合作前、中、后全周期提供高效服务保障，坚持使命必达"
              text="体验百应服务"
              backgroundImage="//cdn.byai.com/static/official-website/service/service_banner.svg"
                  ...
                  <Row justify="center">
                    {SERVICE_SUPPORT.map((item, index) => (
                      <Col key={index} lg={6} md={12}>
                        <SupportMD
                          index={index}
                          coverImage="//cdn.byai.com/static/official-website/animation/assistant-1222.svg"
                          title={item.title}
                          descList={item.descList}
                        />
                      </Col>
