...
import { cssSwitch } from '../../../../src/lib/utils';
interface IProps {
  className?: string;
  children?: ReactNode;
}

const E_Commerce_BASE_IMG_URL = `https://cdn.byai.com/static/intro/img/e-commerce-customer-icon`;
...
const matrix = createImgUrlMatrix(5, 8, E_Commerce_BASE_IMG_URL);
      ...
      <div className={className}>
        ...
        <div className="content-wrap">
          <div className="center-title">
            <span>全类目品牌商家运营提效首选</span>
          </div>
          {matrix.map((row, i) => (
            <ByScrollLine width="100%" time={i % 2 === 1 ? '40s' : '20s'} delay={i % 2 === 1 ? '-2.1s' : '0s'} key={i}>
...
const ECommerceCustomerIconsBlock = styled(RawCustomerIconsBlock)<ICustomerIconsBlockProps>`
  img {
    margin: 0px;
  }
  width: 100%;
...
`;
export default ECommerceCustomerIconsBlock;
