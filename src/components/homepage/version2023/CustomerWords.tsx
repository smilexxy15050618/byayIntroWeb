  ...
  return (
    <div style={style}>
      ...
      <Swiper
        ...
        style={{ paddingRight: 32, overflow: 'hidden', paddingBottom: 30, marginBottom: -30 }}>
...
const CustomerWords: FC<ICustomerWordsProps> = ({}) => {
  return (
    <Pane title="客户证言" paneBgColor="grey" style={{ paddingBottom: 152 }} mobileStyle={{ paddingBottom: 40 }}>
      <Hidden xs sm>
