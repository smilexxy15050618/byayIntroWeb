...
interface DevelopHistoryProps {
  minWidthPC?: string;
  backgroundImage?: string;
}

const DevelopHistoryContainer = styled.div<{ maxWidthPc?: string; minWidthPC?: string }>`
...
const DevelopHistory: React.SFC<DevelopHistoryProps> = ({ minWidthPC, backgroundImage }) => {
  return (
    <DevelopHistoryContainer maxWidthPc="1200px" minWidthPC={minWidthPC}>
      {/* <Title>发展历程</Title> */}
