...
const IMG_ONE_TO_ONE = `${PREFIX}/one-to-one.png`;
      ...
      <SuspensionWrapper>
        <SuspensionList>
            ...
            <SuspensionItem
              ...
              {item.tips === '400' && activeIndex === 1 && (
                <HoverPhone>
                  ...
                  <div className="tooltio-content">{CALL_NUMBER_400}</div>
                  <img src="https://cdn.byai.com/node_front/1575636569037/%E8%A7%92.png" className="angle" />
                </HoverPhone>
              )}
              {item.tips === 'partner' && activeIndex === 2 && (
                <HoverPhone>
                  <div className="tooltip-title">渠道合作</div>
                  <img src="https://cdn.byai.com/node_front/1575636569037/%E8%A7%92.png" className="angle" />
                </HoverPhone>
              )}
            </SuspensionItem>
          ...
          <SuspensionItem className="qimo-toggler" onClick={() => this.setState({ welcomeVisible: !welcomeVisible })}>
            <div className="suspension-icon" onClick={() => setForm(true, FormType.CUSTOMER)}>
              <Conversation />
            </div>
          </SuspensionItem>
